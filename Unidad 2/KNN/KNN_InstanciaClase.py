...
##Practica..
#  Generar un codigo en arduino que envie a python un vector NC
#  de su instancia de datos. posteriomente python deberá calclar
#  la clase moda que será asignada a NC
